    ...
    <div class="mt-8 grid gap-4 sm:grid-cols-2">
      @for (section of sections; track section.path) {
        <a
          ...
          class="group focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring rounded-lg"
        >
...
export class Overview {
  protected readonly sections = [
    ...
    { path: 'charts', label: 'Charts', blurb: 'ngx-charts on the token palette' },
  ] as const;
}
